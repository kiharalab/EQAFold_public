...
def vecs_from_tensor(x: np.ndarray  # shape (..., 3)
  ...
  #modified
  return Vecs(torch.tensor(x[..., 0]), torch.tensor(x[..., 1]), torch.tensor(x[..., 2]))
...
def vecs_squared_distance(v1: Vecs, v2: Vecs) -> np.ndarray:
  ...
  #print(squared_difference(v1.x, v2.x).mean())
  #print(squared_difference(v1.y, v2.y).mean())
  #print(squared_difference(v1.z, v2.z).mean())
